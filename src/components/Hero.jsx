    ...
    <section id="home" className="relative pt-20 pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <span className="text-fuchsia-300 font-semibold tracking-wider text-sm uppercase mb-6 block">
            AE-MAP (Autoencoder-Based Multi-Omics Analysis Platform)
          </span>
          <motion.h1 
          ...
          >
            <a 
              href="#live-demo"
              className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-full text-white bg-indigo-500/80 hover:bg-indigo-500 shadow-lg hover:shadow-xl transition-all gap-2"
            >
              See It In Action
        ...
        >
          <div className="relative w-full max-w-lg h-64">
            <svg viewBox="0 0 400 250" className="w-full h-full overflow-visible">
              ...
              />
              <text x="30" y="45" className="text-sm fill-slate-400 font-medium">DNA (Genomics)</text>
              ...
              />
              <text x="30" y="120" className="text-sm fill-slate-400 font-medium">RNA (Transcriptomics)</text>
              ...
              />
              <text x="30" y="220" className="text-sm fill-slate-400 font-medium">Protein (Proteomics)</text>
              
              {/* Bottleneck/Unified Output */}
              <circle cx="350" cy="125" r="15" fill="#0f766e" />
              <text x="375" y="130" className="text-sm fill-slate-200 font-bold">Unified Profile</text>
            </svg>
          </div>
        </motion.div>
      </div>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-fuchsia-500/10 blur-3xl opacity-50"></div>
